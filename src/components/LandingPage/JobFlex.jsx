          ...
          {[...jobs, ...jobs, ...jobs].map((job, index) => (
            <button
              ...
              className="flex items-center justify-center min-w-[120px] md:min-w-[200px] mx-2 md:mx-4 px-4 md:px-6 h-10 md:h-12 
                text-sm md:text-base text-black border border-gray-300 rounded-full hover:text-purple-700 
                hover:border-purple-700 transition-colors duration-200 whitespace-nowrap font-semibold"
            >
              {job}
            </button>
          ))}
